...
class TechnicalDocumentationGenerator:
    ...
    def __init__(
        self, policy_engine: Optional[PolicyEngine] = None, ledger: Optional[LedgerChain] = None
    ):
        self.policy_engine = policy_engine
        self.ledger = ledger

    def generate(self, system_info: Optional[Dict[str, Any]] = None) -> TechnicalDocumentation:
        """
    ...
    def export_markdown(self, doc: TechnicalDocumentation) -> str:
        ...
        md = f"""# EU AI Act Article 11 Technical Documentation
